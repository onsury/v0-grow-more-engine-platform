...
import { Star, ExternalLink, Shield, CheckCircle, XCircle, Users, DollarSign, Stethoscope } from "lucide-react"
import { companies } from "@/data/real-companies"

export default function JammiAyurvedicConsultationPage() {
  const company = companies.find((c) => c.id === "jammi")!
  const product = company.products.find((p) => p.id === "jammi-ayurvedic-consultation")!
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border-2 border-orange-200">
          <div className="flex flex-col lg:flex-row items-start gap-8">
            ...
            <div className="flex-1">
              ...
              <div className="bg-green-50 p-4 rounded-xl mb-6 border-l-4 border-green-500">
                <p className="text-green-800 font-medium">
                  <strong>Clinical Reality:</strong> From juvenile jaundice to cirrhosis, from diabetes to stress, from
                  thyroid to constipation, they've seen it all—and treated it before you could pronounce it.
                </p>
              </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border-2 border-orange-200">
          <h2 className="text-2xl font-bold mb-6 bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent">
            🏥 The Clinical Experience: 127 Years of Healing Wisdom
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-bold text-green-700 mb-4">🩺 What They Treat:</h3>
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-2" />
                  <span>Liver conditions (their specialty)</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-2" />
                ...
                <li className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-2" />
                  <span>Anemia and blood disorders</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-2" />
                  <span>Stress and insomnia</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-2" />
                  <span>Women's & Men's wellness</span>
                </li>
              </ul>
            </div>
            <div>
              <h3 className="text-xl font-bold text-orange-700 mb-4">🎯 The Jammi Approach:</h3>
              <div className="bg-orange-50 p-6 rounded-xl">
                <p className="text-gray-800 mb-4">
                  <strong>This isn't some flash-in-the-pan Insta-ayurveda.</strong> This is 127 years of sweat, science,
                  and sambar-fed wisdom treating patients without the side effects or side-eye.
                </p>
                <p className="text-gray-700 text-sm">
                  While the rest of the world is popping pills and googling 'natural cures,' you could just book an
                  appointment at Jammi's. They've been treating patients since before Google existed.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          <Card className="border-2 border-blue-200">
            ...
            <CardContent className="pt-6">
              ...
              <div className="text-sm text-gray-600 mb-4">Per Consultation</div>
              ...
              <p className="text-xs text-gray-500 mt-4">
                Compare: Specialist consultations in hospitals cost ₹1000+ with less personalized care.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 border-purple-200">
            ...
            <CardContent className="pt-6">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                <div>✅ Chronic condition sufferers</div>
                <div>✅ People seeking holistic treatment</div>
                <div>✅ Those tired of side effects</div>
                <div>✅ Lifestyle disease patients</div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="pt-6">
              ...
              <div className="bg-green-100 p-4 rounded-lg">
                <p className="text-green-800 text-sm font-medium">
                  "This is living Ayurveda, not wellness theater. Full-stack healthcare with lifecycle engagement from
        ...
        <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 rounded-2xl shadow-xl p-8 text-white text-center">
          <h2 className="text-3xl font-bold mb-4">Ready for Real Ayurvedic Treatment?</h2>
          <p className="text-lg mb-6 opacity-90">
            Stop googling symptoms and start with 127 years of proven clinical experience. Book your consultation today.
          </p>
